...
implements ActionListener, Runnable {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(obj==bt1/*connect*/) {
			...
			try {
				FileWriter fw=new FileWriter("ch20/"+System.currentTimeMillis()+".txt");
				fw.write(str);
				fw.flush();
				fw.close();
				area.setText("");//초기화시키기
				...
				e1.printStackTrace();
			}//현재 이렇게 하면 왜 에러남? try catch 해줘야하암
		}else if(obj==bt3/*message*/) { // 서버에서 구현하는거라 routin 루틴에서 구현해야함!!!
			new Message("TO:");
			...
			if(!flag)/*아이디 입력일때 */ {
				...
				if(i==-1 || i==0)/*전체채팅*/  {
					...
					sendMessage(ChatProtocol2.CHAT+":"+id+";"+str); // 콜론이랑 세미콜론 둘 다 사용함!! ":" & ";" 주의!!!!!!!!!!!!
				}
				tf3.setText("");
				tf3.requestFocus();
			}
